...
Βασικά, ας προσθέσουμε ακόμα μία λεπτομέρεια: προτού ένας <icon s></icon> γίνει <icon i></icon>, πρώτα γίνεται <icon e></icon> Εκτεθειμένος. Αυτό σημαίνει όταν κάποιος έχει τον ιό αλλά δεν μπορεί να τον μεταδώσει ακόμα – είναι μολυσμ*ένος* αλλά όχι ακόμα μολυσμ*ατικός*.
...
* η COVID-19 είναι στενά συνδεδεμένη με τον SARS, ο οποίος έδωσε στους επιζώντες αυτού 2 χρόνια ανοσίας.[^SARS_immunity]
